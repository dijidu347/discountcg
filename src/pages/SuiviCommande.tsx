...
const SuiviCommande = () => {
  ...
  const carteGriseDetail = carteGriseDetailFromColumns({
    prix_cv: order.prix_cv,
    prix_cv_avant_abattement: order.prix_cv_avant_abattement,
    taxe_parafiscale: order.taxe_parafiscale,
    sous_total_arrondi: order.sous_total_arrondi,
            ...
            <CardContent className="space-y-3">
              ...
              {order.email_notifications ? (
                <div className="flex items-center justify-between p-3 rounded-lg bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800">
                  ...
                  <span className="text-sm text-green-600 font-medium">5,00 €</span>
                </div>
              ) : (

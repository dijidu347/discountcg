...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      get_admin_revenue_totals: {
        Args: { p_end?: string; p_start?: string }
        Returns: {
          avg_revenue_per_demarche: number
          cb_paid_demarches: number
          free_token_demarches: number
          token_paid_demarches: number
          total_demarches: number
          total_revenue: number
          total_service_fees: number
          total_token_revenue: number

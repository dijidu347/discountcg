...
CREATE TABLE IF NOT EXISTS coffre_subscriptions (
...
CREATE INDEX IF NOT EXISTS idx_coffre_documents_garage_date ON coffre_documents(garage_id, document_date DESC);
CREATE INDEX IF NOT EXISTS idx_coffre_documents_garage_created ON coffre_documents(garage_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_coffre_documents_garage_category ON coffre_documents(garage_id, category);
